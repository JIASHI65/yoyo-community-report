...
def arkanalyze(messages):
    ...
    if not meaningful: return {"hot_discussions":[],"user_sentiment":"","pain_points":[],"highlights":[],"notable_quotes":[],"emerging_topics":"","keyword_cloud":[],"weekly_summary":"",}
        ...
        if item.get("type") == "message":
            for c in item.get("content",[]):
                if c.get("type") == "output_text":
                    ...
                    except: return {"hot_discussions":[],"user_sentiment":c.get("text","")[:200],"pain_points":[],"highlights":[],"notable_quotes":[],"emerging_topics":"","keyword_cloud":[],"weekly_summary":"",}
    return {"hot_discussions":[],"user_sentiment":"分析失败","pain_points":[],"highlights":[],"notable_quotes":[],"emerging_topics":"","keyword_cloud":[],"weekly_summary":"",}
