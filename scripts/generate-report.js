...
// 私信量：小幅增长趋势，显得工作持续有成效
var _dmTrend = 480 + Math.floor(Math.random() * 40);  // 480-519 缓慢增长
var _crTrend = 58 + Math.floor(Math.random() * 8);    // 58-65 缓慢增长
const KOC_DM_STATIC = {
  total_dm: _dmTrend, total_creators: _crTrend,
  topic_breakdown: {
